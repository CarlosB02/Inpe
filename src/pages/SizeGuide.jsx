...
const SizeGuide = () => {
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '6rem 2rem' }}>
            <h1 style={{ textAlign: 'center', color: 'var(--color-deep-blue)', marginBottom: '2rem' }}>Guia de Tamanhos</h1>
            <p style={{ textAlign: 'center', marginBottom: '4rem', color: 'var(--color-secondary)' }}>
                Para garantir o conforto e o desenvolvimento natural, é essencial escolher o tamanho certo.
                Recomendamos deixar uma folga de 0,8 a 1,2 cm.
            </p>

            <div style={{ overflowX: 'auto', borderRadius: 'var(--border-radius)', boxShadow: 'var(--shadow-soft)' }}>
